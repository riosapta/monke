...
class _editRecordState extends State<EditRecord> {
  String selectedCategory = globals.initCategory;
  String selectedAccount = globals.initAccount;
  String selectedAccount2 = 'Select Account';
  int secondaryIndex = 1;
  List<String> lstTwo = ['Income', 'Expense', 'Transfer'];
  DateTime selectedDate = globals.initDate;
  TimeOfDay time = TimeOfDay.now();
  int initAmount = 0;
  List<Widget> accData = [];
  List<Widget> catData = [];
  int accIndex = 0;
  String selectedJenis = globals.initJenis;
  final amountController =
      TextEditingController(text: globals.initJumlah.toString());
  final noteController = TextEditingController(text: globals.initNote);
  String currency =
      'Rp'; ///////////////////////////////////////////////////////////////////////////////// CURRENCY
  ...
  void initState() {
    ...
    accountList();
    categoryList();
    if (selectedJenis == 'Income') {
      secondaryIndex = 0;
    }
    if (selectedJenis == 'Expense') {
      secondaryIndex = 1;
    }
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> updateTrx(int amount, note) {
