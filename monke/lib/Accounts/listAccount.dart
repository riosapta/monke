...
class ListAccount extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _ListAccount();
}

class _ListAccount extends State<ListAccount> {
          ...
          child:
            OutlinedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                side: BorderSide(color: pickedIndex == idx2 ? Colors.teal : Colors.transparent, width: 3)// <-- Button color
              ),
            )
        ),
        // footer: Text(
